 ...
 * This class represents the view class in MVC model.
 * In 3-tier architecture, this class sits on presentation layer.
 *  
 * @author emalianakasmuri
 *
 */

public class MultiWeightsFrame extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		MultiWeightsAppDelegator multiDelegator = new MultiWeightsAppDelegator();
